...
for sae_block_pattern in "${sae_block_patterns[@]}"; do
    ...
    python external/sae_bench/evals/absorption/main.py \
...
for sae_block_pattern in "${sae_block_patterns[@]}"; do
    echo "Starting pattern ${sae_block_pattern}..."
    python external/sae_bench/evals/autointerp/main.py \
        --sae_regex_pattern "${sae_regex_pattern}" \
        --sae_block_pattern "${sae_block_pattern}" \
...
for sae_block_pattern in "${sae_block_patterns[@]}"; do
    ...
    python external/sae_bench/evals/core/main.py "${sae_regex_pattern}" "${sae_block_pattern}" \
...
for sae_block_pattern in "${sae_block_patterns[@]}"; do
    ...
    python external/sae_bench/evals/scr_and_tpp/main.py \
    --sae_regex_pattern "${sae_regex_pattern}" \
    --sae_block_pattern "${sae_block_pattern}" \
    --model_name ${model_name} \
    --perform_scr true \
...
for sae_block_pattern in "${sae_block_patterns[@]}"; do
    ...
    python external/sae_bench/evals/sparse_probing/main.py \
    --sae_regex_pattern "${sae_regex_pattern}" \
    --sae_block_pattern "${sae_block_pattern}" \
    --model_name ${model_name} \
    --clean_up_activations \
...
for sae_block_pattern in "${sae_block_patterns[@]}"; do
    ...
    python external/sae_bench/evals/ravel/main.py \
    --sae_regex_pattern "${sae_regex_pattern}" \
    --sae_block_pattern "${sae_block_pattern}" \
    --model_name ${model_name} || {
...
#     python external/sae_bench/evals/unlearning/main.py \
#     --sae_regex_pattern "${sae_regex_pattern}" \
#     --sae_block_pattern "${sae_block_pattern}" \
