...
for sae_block_pattern in sae_block_patterns:
    ...
    cmd = [
        "python",
        "external/sae_bench/evals/scr_and_tpp/main.py",
        "--sae_regex_pattern",
        sae_regex_pattern,
        "--sae_block_pattern",
        sae_block_pattern,
...
for sae_block_pattern in sae_block_patterns:
    ...
    cmd = [
        "python",
        "external/sae_bench/evals/sparse_probing/main.py",
        "--sae_regex_pattern",
        sae_regex_pattern,
        "--sae_block_pattern",
        sae_block_pattern,
...
for sae_block_pattern in sae_block_patterns:
    ...
    cmd = [
        "python",
        "external/sae_bench/evals/absorption/main.py",
        "--sae_regex_pattern",
        sae_regex_pattern,
        "--sae_block_pattern",
        sae_block_pattern,
...
for sae_block_pattern in sae_block_patterns:
    ...
    cmd = [
        "python",
        "external/sae_bench/evals/autointerp/main.py",
        "--sae_regex_pattern",
        sae_regex_pattern,
        "--sae_block_pattern",
        sae_block_pattern,
...
for sae_block_pattern in sae_block_patterns:
    ...
    cmd = [
        "python",
        "external/sae_bench/evals/core/main.py",
        sae_regex_pattern,
        sae_block_pattern,
        "--batch_size_prompts",
        "2",
...
for sae_block_pattern in sae_block_patterns:
    ...
    cmd = [
        "python",
        "external/sae_bench/evals/unlearning/main.py",
        "--sae_regex_pattern",
        sae_regex_pattern,
        "--sae_block_pattern",
        sae_block_pattern,
