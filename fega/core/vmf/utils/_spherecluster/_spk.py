### credit to Erwin: https://stackoverflow.com/questions/72572969/problems-using-spherecluster-package-for-spherical-k-mean-clustering
# ruff: noqa
...
# PHU'S ENHANCE: sklearn private imports moved in newer versions.
...
# PHU'S ENHANCE: private module path updated for sklearn>=1.x.
...
def _spherical_kmeans_single_lloyd(
    ...
    # init
    # PHU'S ENHANCE: use KMeans private helpers to match sklearn>=1.x API.
...
def spherical_k_means(
    ...
    if hasattr(init, "__array__"):
        ...
        # PHU'S ENHANCE: call private validator to match sklearn>=1.x API.
